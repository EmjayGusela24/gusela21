...
const CandidateProfile: React.FC<{
  ...
  return (
    <div className="screen-content content-max-width">
      ...
      <div style={{ textAlign: "center", padding: "48px 20px", background: "white", borderRadius: "24px", boxShadow: "0 10px 40px rgba(11,23,54,0.08)", marginBottom: "32px", position: "relative", overflow: "hidden", border: "1px solid var(--border-light)" }}>
        ...
        />
        <h1 style={{ color: "var(--primary-navy)", fontSize: "36px", marginBottom: "12px", position: "relative", zIndex: 1, letterSpacing: "-0.02em" }}>{candidate.name}</h1>
        <span className="badge-cyan" style={{ fontSize: "15px", padding: "8px 16px", position: "relative", zIndex: 1, fontWeight: 700, letterSpacing: "0.02em" }}>
          {candidate.position}
        </span>
      </div>
